function [t,y,num_pass,lights,vehicle,timer]=...
    princessparkwaytraffic(rands01,varargin)
%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
% >>[t,y,num_pass,lights,vehicle,timer]=princessparkwaytraffic(rands01);
% 
...
%
% >>[t,y,num_pass,lights,vehicle,timer]=princessparkwaytraffic(rands01,0);
%
...
%
% >>[t,y,num_pass,lights,vehicle,timer]=princessparkwaytraffic(rands01,1,0.5);
%--------------------------------------------------------------------------
...
s.length=3091;          % length of green lane in metres.
s.m_s=1431;              % distance from roundabout to mitchell-shackleton.
s.ups=3091;              % distance from roundabout to UPS 
s.cromwell=940;         % distance from roundabout to cromwell.
s.trafficlight1=578.9;   % distance from roundabout to traffic light 1.
s.trafficlight2=893.1;   % distance from roundabout to traffic light 2.

s.n_cars_rate=2600*24;      % number of cars per day
